...
1. `git clone https://github.com/niiima/next-webpack-marko.git your-project-name`
...
This is a great plugin that generates every single icon you'll ever need based off one image source. In my `src/images/` folder I have a `next-package.svg` that I input into the [favicons-webpack-plugin](https://github.com/jantimon/favicons-webpack-plugin).
...
module.exports = merge(common, {
  ...
  plugins: [
    new FaviconsWebpackPlugin({
      logo: './src/images/next-package.svg',
      icons: {
        twitter: true,
        windows: true
      }
...
##Rreference
This project is based on [tris-webpack-boilerplate](https://github.com/tr1s/tris-webpack-boilerplate)
